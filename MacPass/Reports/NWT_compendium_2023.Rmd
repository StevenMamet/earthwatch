...
- \usepackage{fancyhdr}
- \pagestyle{fancy}
# - \fancyhead[R]{\includegraphics[width=3cm]{ems logo only-01.jpg}}
- \usepackage{lastpage}
- \usepackage{dcolumn}
...
```{r, echo=FALSE,  fig.cap="Figure 2. Oblique photos of each of the permafrost monitoring sites. Photo credits: Steven Mamet.", out.width="15cm"}
