...
## NALP - fir
mm_nalp_fir_no_seed <- data.frame(year = (rep(c(1:5), c(length(mm_nalp_fir_no$surv_prop_0[mm_nalp_fir_no$treatment == "seeded"]),
...
mm_nalp_fir_ex_seed <- data.frame(year = (rep(c(1:5), c(length(mm_nalp_fir_ex$surv_prop_0[mm_nalp_fir_ex$treatment == "seeded"]),
...
mm_nalp_fir_no_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_nalp_fir_no$surv_prop_0[mm_nalp_fir_no$treatment == "seeded.scarified"]),
...
mm_nalp_fir_ex_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_nalp_fir_ex$surv_prop_0[mm_nalp_fir_ex$treatment == "seeded.scarified"]),
...
mm_nalp_fir_no_seed_ci <- data.frame(predict(mm_nalp_fir_no_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_nalp_fir_no_seed_ci$fit <- exp(mm_nalp_fir_no_seed_ci$fit)-1
mm_nalp_fir_no_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_nalp_fir_ex_seed_ci <- data.frame(predict(mm_nalp_fir_ex_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_nalp_fir_ex_seed_ci$fit <- exp(mm_nalp_fir_ex_seed_ci$fit)-1
mm_nalp_fir_ex_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_nalp_fir_no_seedscar_ci <- data.frame(predict(mm_nalp_fir_no_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_nalp_fir_no_seedscar_ci$fit <- exp(mm_nalp_fir_no_seedscar_ci$fit)-1
mm_nalp_fir_no_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_nalp_fir_ex_seedscar_ci <- data.frame(predict(mm_nalp_fir_ex_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_nalp_fir_ex_seedscar_ci$fit <- exp(mm_nalp_fir_ex_seedscar_ci$fit)-1
mm_nalp_fir_ex_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
                                       surv_mean = mm_nalp_fir_ex_seedscar_ci$fit) #only doing wells with 2015-2020 data

## SALP - fir
mm_salp_fir_no_seed <- data.frame(year = (rep(c(1:5), c(length(mm_salp_fir_no$surv_prop_0[mm_salp_fir_no$treatment == "seeded"]),
...
mm_salp_fir_ex_seed <- data.frame(year = (rep(c(1:5), c(length(mm_salp_fir_ex$surv_prop_0[mm_salp_fir_ex$treatment == "seeded"]),
...
mm_salp_fir_no_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_salp_fir_no$surv_prop_0[mm_salp_fir_no$treatment == "seeded.scarified"]),
...
mm_salp_fir_ex_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_salp_fir_ex$surv_prop_0[mm_salp_fir_ex$treatment == "seeded.scarified"]),
...
mm_salp_fir_no_seed_ci <- data.frame(predict(mm_salp_fir_no_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_salp_fir_no_seed_ci$fit <- exp(mm_salp_fir_no_seed_ci$fit)-1
mm_salp_fir_no_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_salp_fir_ex_seed_ci <- data.frame(predict(mm_salp_fir_ex_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_salp_fir_ex_seed_ci$fit <- exp(mm_salp_fir_ex_seed_ci$fit)-1
mm_salp_fir_ex_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_salp_fir_no_seedscar_ci <- data.frame(predict(mm_salp_fir_no_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_salp_fir_no_seedscar_ci$fit <- exp(mm_salp_fir_no_seedscar_ci$fit)-1
mm_salp_fir_no_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_salp_fir_ex_seedscar_ci <- data.frame(predict(mm_salp_fir_ex_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_salp_fir_ex_seedscar_ci$fit <- exp(mm_salp_fir_ex_seedscar_ci$fit)-1
mm_salp_fir_ex_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
...
## NALP - spruce
mm_nalp_spruce_no_seed <- data.frame(year = (rep(c(1:5), c(length(mm_nalp_spruce_no$surv_prop_0[mm_nalp_spruce_no$treatment == "seeded"]),
...
mm_nalp_spruce_ex_seed <- data.frame(year = (rep(c(1:5), c(length(mm_nalp_spruce_ex$surv_prop_0[mm_nalp_spruce_ex$treatment == "seeded"]),
...
mm_nalp_spruce_no_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_nalp_spruce_no$surv_prop_0[mm_nalp_spruce_no$treatment == "seeded.scarified"]),
...
mm_nalp_spruce_ex_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_nalp_spruce_ex$surv_prop_0[mm_nalp_spruce_ex$treatment == "seeded.scarified"]),
...
mm_nalp_spruce_no_seed_ci <- data.frame(predict(mm_nalp_spruce_no_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_nalp_spruce_no_seed_ci$fit <- exp(mm_nalp_spruce_no_seed_ci$fit)-1
mm_nalp_spruce_no_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_nalp_spruce_ex_seed_ci <- data.frame(predict(mm_nalp_spruce_ex_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_nalp_spruce_ex_seed_ci$fit <- exp(mm_nalp_spruce_ex_seed_ci$fit)-1
mm_nalp_spruce_ex_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_nalp_spruce_no_seedscar_ci <- data.frame(predict(mm_nalp_spruce_no_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_nalp_spruce_no_seedscar_ci$fit <- exp(mm_nalp_spruce_no_seedscar_ci$fit)-1
mm_nalp_spruce_no_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_nalp_spruce_ex_seedscar_ci <- data.frame(predict(mm_nalp_spruce_ex_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_nalp_spruce_ex_seedscar_ci$fit <- exp(mm_nalp_spruce_ex_seedscar_ci$fit)-1
mm_nalp_spruce_ex_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
                                           surv_mean = mm_nalp_spruce_ex_seedscar_ci$fit) #only doing wells with 2015-2020 data

## SALP - spruce
mm_salp_spruce_no_seed <- data.frame(year = (rep(c(1:5), c(length(mm_salp_spruce_no$surv_prop_0[mm_salp_spruce_no$treatment == "seeded"]),
...
mm_salp_spruce_ex_seed <- data.frame(year = (rep(c(1:5), c(length(mm_salp_spruce_ex$surv_prop_0[mm_salp_spruce_ex$treatment == "seeded"]),
...
mm_salp_spruce_no_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_salp_spruce_no$surv_prop_0[mm_salp_spruce_no$treatment == "seeded.scarified"]),
...
mm_salp_spruce_ex_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_salp_spruce_ex$surv_prop_0[mm_salp_spruce_ex$treatment == "seeded.scarified"]),
...
mm_salp_spruce_no_seed_ci <- data.frame(predict(mm_salp_spruce_no_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_salp_spruce_no_seed_ci$fit <- exp(mm_salp_spruce_no_seed_ci$fit)-1
mm_salp_spruce_no_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_salp_spruce_ex_seed_ci <- data.frame(predict(mm_salp_spruce_ex_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_salp_spruce_ex_seed_ci$fit <- exp(mm_salp_spruce_ex_seed_ci$fit)-1
mm_salp_spruce_ex_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_salp_spruce_no_seedscar_ci <- data.frame(predict(mm_salp_spruce_no_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_salp_spruce_no_seedscar_ci$fit <- exp(mm_salp_spruce_no_seedscar_ci$fit)-1
mm_salp_spruce_no_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_salp_spruce_ex_seedscar_ci <- data.frame(predict(mm_salp_spruce_ex_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_salp_spruce_ex_seedscar_ci$fit <- exp(mm_salp_spruce_ex_seedscar_ci$fit)-1
mm_salp_spruce_ex_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
                                           surv_mean = mm_salp_spruce_ex_seedscar_ci$fit) #only doing wells with 2015-2020 data

## SCUT - fir
mm_scut_fir_no_seed <- data.frame(year = (rep(c(1:5), c(length(mm_scut_fir_no$surv_prop_0[mm_scut_fir_no$treatment == "seeded"]),
...
mm_scut_fir_ex_seed <- data.frame(year = (rep(c(1:5), c(length(mm_scut_fir_ex$surv_prop_0[mm_scut_fir_ex$treatment == "seeded"]),
...
mm_scut_fir_no_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_scut_fir_no$surv_prop_0[mm_scut_fir_no$treatment == "seeded.scarified"]),
...
mm_scut_fir_ex_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_scut_fir_ex$surv_prop_0[mm_scut_fir_ex$treatment == "seeded.scarified"]),
...
# mm_scut_fir_no_seed_ci <- data.frame(predict(mm_scut_fir_no_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
# mm_scut_fir_no_seed_ci$fit <- exp(mm_scut_fir_no_seed_ci$fit)-1
# mm_scut_fir_no_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_scut_fir_ex_seed_ci <- data.frame(predict(mm_scut_fir_ex_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_scut_fir_ex_seed_ci$fit <- exp(mm_scut_fir_ex_seed_ci$fit)-1
mm_scut_fir_ex_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
# mm_scut_fir_no_seedscar_ci <- data.frame(predict(mm_scut_fir_no_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
# mm_scut_fir_no_seedscar_ci$fit <- exp(mm_scut_fir_no_seedscar_ci$fit)-1
# mm_scut_fir_no_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_scut_fir_ex_seedscar_ci <- data.frame(predict(mm_scut_fir_ex_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_scut_fir_ex_seedscar_ci$fit <- exp(mm_scut_fir_ex_seedscar_ci$fit)-1
mm_scut_fir_ex_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
                                           surv_mean = mm_scut_fir_ex_seedscar_ci$fit) #only doing wells with 2015-2020 data

## SSHR - fir
mm_sshr_fir_no_seed <- data.frame(year = (rep(c(1:5), c(length(mm_sshr_fir_no$surv_prop_0[mm_sshr_fir_no$treatment == "seeded"]),
...
mm_sshr_fir_ex_seed <- data.frame(year = (rep(c(1:5), c(length(mm_sshr_fir_ex$surv_prop_0[mm_sshr_fir_ex$treatment == "seeded"]),
...
mm_sshr_fir_no_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_sshr_fir_no$surv_prop_0[mm_sshr_fir_no$treatment == "seeded.scarified"]),
...
mm_sshr_fir_ex_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_sshr_fir_ex$surv_prop_0[mm_sshr_fir_ex$treatment == "seeded.scarified"]),
...
# mm_sshr_fir_no_seed_ci <- data.frame(predict(mm_sshr_fir_no_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
# mm_sshr_fir_no_seed_ci$fit <- exp(mm_sshr_fir_no_seed_ci$fit)-1
# mm_sshr_fir_no_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_sshr_fir_ex_seed_ci <- data.frame(predict(mm_sshr_fir_ex_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_sshr_fir_ex_seed_ci$fit <- exp(mm_sshr_fir_ex_seed_ci$fit)-1
mm_sshr_fir_ex_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_sshr_fir_no_seedscar_ci <- data.frame(predict(mm_sshr_fir_no_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_sshr_fir_no_seedscar_ci$fit <- exp(mm_sshr_fir_no_seedscar_ci$fit)-1
mm_sshr_fir_no_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_sshr_fir_ex_seedscar_ci <- data.frame(predict(mm_sshr_fir_ex_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_sshr_fir_ex_seedscar_ci$fit <- exp(mm_sshr_fir_ex_seedscar_ci$fit)-1
mm_sshr_fir_ex_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
                                           surv_mean = mm_sshr_fir_ex_seedscar_ci$fit) #only doing wells with 2015-2020 data

## SCUT - spruce
mm_scut_spruce_no_seed <- data.frame(year = (rep(c(1:5), c(length(mm_scut_spruce_no$surv_prop_0[mm_scut_spruce_no$treatment == "seeded"]),
...
mm_scut_spruce_ex_seed <- data.frame(year = (rep(c(1:5), c(length(mm_scut_spruce_ex$surv_prop_0[mm_scut_spruce_ex$treatment == "seeded"]),
...
mm_scut_spruce_no_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_scut_spruce_no$surv_prop_0[mm_scut_spruce_no$treatment == "seeded.scarified"]),
...
mm_scut_spruce_ex_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_scut_spruce_ex$surv_prop_0[mm_scut_spruce_ex$treatment == "seeded.scarified"]),
...
mm_scut_spruce_no_seed_ci <- data.frame(predict(mm_scut_spruce_no_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_scut_spruce_no_seed_ci$fit <- exp(mm_scut_spruce_no_seed_ci$fit)-1
mm_scut_spruce_no_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_scut_spruce_ex_seed_ci <- data.frame(predict(mm_scut_spruce_ex_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_scut_spruce_ex_seed_ci$fit <- exp(mm_scut_spruce_ex_seed_ci$fit)-1
mm_scut_spruce_ex_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_scut_spruce_no_seedscar_ci <- data.frame(predict(mm_scut_spruce_no_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_scut_spruce_no_seedscar_ci$fit <- exp(mm_scut_spruce_no_seedscar_ci$fit)-1
mm_scut_spruce_no_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_scut_spruce_ex_seedscar_ci <- data.frame(predict(mm_scut_spruce_ex_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_scut_spruce_ex_seedscar_ci$fit <- exp(mm_scut_spruce_ex_seedscar_ci$fit)-1
mm_scut_spruce_ex_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
                                           surv_mean = mm_scut_spruce_ex_seedscar_ci$fit) #only doing wells with 2015-2020 data

## SSHR - spruce
mm_sshr_spruce_no_seed <- data.frame(year = (rep(c(1:5), c(length(mm_sshr_spruce_no$surv_prop_0[mm_sshr_spruce_no$treatment == "seeded"]),
...
mm_sshr_spruce_ex_seed <- data.frame(year = (rep(c(1:5), c(length(mm_sshr_spruce_ex$surv_prop_0[mm_sshr_spruce_ex$treatment == "seeded"]),
...
mm_sshr_spruce_no_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_sshr_spruce_no$surv_prop_0[mm_sshr_spruce_no$treatment == "seeded.scarified"]),
...
mm_sshr_spruce_ex_seedscar <- data.frame(year = (rep(c(1:5), c(length(mm_sshr_spruce_ex$surv_prop_0[mm_sshr_spruce_ex$treatment == "seeded.scarified"]),
...
# mm_sshr_spruce_no_seed_ci <- data.frame(predict(mm_sshr_spruce_no_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
# mm_sshr_spruce_no_seed_ci$fit <- exp(mm_sshr_spruce_no_seed_ci$fit)-1
# mm_sshr_spruce_no_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_sshr_spruce_ex_seed_ci <- data.frame(predict(mm_sshr_spruce_ex_seed_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_sshr_spruce_ex_seed_ci$fit <- exp(mm_sshr_spruce_ex_seed_ci$fit)-1
mm_sshr_spruce_ex_seed_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_sshr_spruce_no_seedscar_ci <- data.frame(predict(mm_sshr_spruce_no_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_sshr_spruce_no_seedscar_ci$fit <- exp(mm_sshr_spruce_no_seedscar_ci$fit)-1
mm_sshr_spruce_no_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
...
mm_sshr_spruce_ex_seedscar_ci <- data.frame(predict(mm_sshr_spruce_ex_seedscar_mod, newdata=data.frame(year=seq(1,5,0.1)), interval="confidence", level = 0.95))
mm_sshr_spruce_ex_seedscar_ci$fit <- exp(mm_sshr_spruce_ex_seedscar_ci$fit)-1
mm_sshr_spruce_ex_seedscar_mean <- data.frame(year.vals = seq(1,5,0.1),
...
summary(bp_150.w_lm <- lm(bp_150 ~ season_year, data = mm_temps_w[-c(1,33),]))  # b1 = 0.046, P = 0.00705 **
summary(hf_150.w_lm <- lm(hf_150 ~ season_year, data = mm_temps_w[-c(1,33),]))  # b1 = 0.033, P = 0.0437 *
summary(d6_150.w_lm <- lm(d6_150 ~ season_year, data = mm_temps_w[c(8:32),]))   # b1 = 0.011, P = 0.5497
summary(d2_150.w_lm <- lm(d2_150 ~ season_year, data = mm_temps_w[-c(1,33),]))  # b1 = 0.026, P = 0.127
summary(gf_150.w_lm <- lm(gf_150 ~ season_year, data = mm_temps_w[-c(1,33),]))  # b1 = 0.043, P = 0.0277 *

summary(bp_150.c_lm <- lm(bp_150 ~ season_year, data = mm_temps_c[-32,]))       # b1 = 0.027, P = 0.462
summary(hf_150.c_lm <- lm(hf_150 ~ season_year, data = mm_temps_c[-32,]))       # b1 = 0.026, P = 0.5368
summary(d6_150.c_lm <- lm(d6_150 ~ season_year, data = mm_temps_c[c(6:31),]))   # b1 = 0.051, P = 0.281
summary(d2_150.c_lm <- lm(d2_150 ~ season_year, data = mm_temps_c[-32,]))       # b1 = 0.025, P = 0.440
summary(gf_150.c_lm <- lm(gf_150 ~ season_year, data = mm_temps_c[-32,]))       # b1 = 0.047, P = 0.1067  

## Ground surface regressions
summary(bp_0.w_lm <- lm(bp_0 ~ season_year, data = mm_temps_w[-c(1,33),]))  # b1 = 0.027, P = 0.0818 .
summary(hf_0.w_lm <- lm(hf_0 ~ season_year, data = mm_temps_w[-c(1,33),]))  # b1 = -0.014, P = 0.345
summary(d6_0.w_lm <- lm(d6_0 ~ season_year, data = mm_temps_w[c(8:32),]))   # b1 = 0.018, P = 0.563
summary(d2_0.w_lm <- lm(d2_0 ~ season_year, data = mm_temps_w[-c(1,33),]))  # b1 = 0.025, P = 0.112
summary(gf_0.w_lm <- lm(gf_0 ~ season_year, data = mm_temps_w[-c(1,33),]))  # b1 = 0.075, P = 0.000933 ***

summary(bp_0.c_lm <- lm(bp_0 ~ season_year, data = mm_temps_c[-32,]))       # b1 = 0.060, P = 0.0441 *
summary(hf_0.c_lm <- lm(hf_0 ~ season_year, data = mm_temps_c[-32,]))       # b1 = 0.081, P = 0.0241 *
summary(d6_0.c_lm <- lm(d6_0 ~ season_year, data = mm_temps_c[c(6:31),]))   # b1 = -0.032, P = 0.135
summary(d2_0.c_lm <- lm(d2_0 ~ season_year, data = mm_temps_c[-32,]))       # b1 = 0.030, P = 0.473
summary(gf_0.c_lm <- lm(gf_0 ~ season_year, data = mm_temps_c[-32,]))       # b1 = 0.166, P = 2.85e-05 ***

## Permafrost regressions
summary(bp_neg150.w_lm <- lm(bp_neg150 ~ season_year, data = mm_temps_w[-c(1,33),])) # b1 = 0.021, P = 0.0001665***
summary(hf_neg150.w_lm <- lm(hf_neg150 ~ season_year, data = mm_temps_w[-c(1,33),])) # b1 = 0.017, P = 4.90e-07 ***
summary(d6_neg150.w_lm <- lm(d6_neg150 ~ season_year, data = mm_temps_w[c(8:32),])) # b1 = -0.003, P = 0.012*
summary(d2_neg150.w_lm <- lm(d2_neg150 ~ season_year, data = mm_temps_w[-c(1,33),])) # b1 = 0.010, P = 0.0469*
summary(gf_neg150.w_lm <- lm(gf_neg150 ~ season_year, data = mm_temps_w[-c(1,33),])) # b1 = 0.016, P = 4.237e-08***

summary(bp_neg150.c_lm <- lm(bp_neg150 ~ season_year, data = mm_temps_c[-32,])) # b1 = 0.033, P = 0.00387 **
summary(hf_neg150.c_lm <- lm(hf_neg150 ~ season_year, data = mm_temps_c[-32,])) # b1 = 0.030, P = 0.0521 .
summary(d6_neg150.c_lm <- lm(d6_neg150 ~ season_year, data = mm_temps_c[c(6:31),])) # b1 = -0.004, P = 0.391
summary(d2_neg150.c_lm <- lm(d2_neg150 ~ season_year, data = mm_temps_c[-32,])) # b1 = 0.036, P = 0.0601 .
summary(gf_neg150.c_lm <- lm(gf_neg150 ~ season_year, data = mm_temps_c[-32,])) # b1 = 0.048, P = 9.54e-09 ***
...
lines(mm_temps_w$season_year[-c(1:7,33)], mm_temps_w$d6_150[-c(1:7,33)], col = "orange")
...
lines(mm_temps_c$season_year[-c(1:6,32)], mm_temps_c$d6_150[-c(1:6,32)], col = "orange")
mtext("Air (°C)", side = 2, line = 2.5, cex = 0.7)
...
lines(mm_temps_c$season_year[-c(1:6,32)], mm_temps_c$d6_0[-c(1:6,32)], col = "orange")
mtext("Ground surface (°C)", side = 2, line = 2.5, cex = 0.7)
...
lines(mm_temps_c$season_year[-c(1:6,32)], mm_temps_c$d6_neg150[-c(1:6,32)], col = "orange")
mtext("Subsurface (°C)", side = 2, line = 2.5, cex = 0.7)
mtext("Year", side = 1, line = 2.5, cex = 0.7)
...
polygon(c(rev(porsild_1$year), porsild_1$year), c(rev(porsild_1$c95), porsild_1$c5), col = alpha("violet",0.6), border = NA)
...
# points(porsild_1$year[32], porsild_1$n[32], col = 'violet', pch = 17)
...
polygon(c(rev(porsild_2$year), porsild_2$year), c(rev(porsild_2$c95), porsild_2$c5), col = alpha("violet",0.6), border = NA)
...
# points(porsild_2$year[32], porsild_2$n[32], col = 'violet', pch = 17)
...
# Export as 5 x 7
jpeg(sprintf("./Earthwatch/MacPass/figures/pipeline_thaw_%s.jpeg", year), width = 6, height = 4, units = "in", res = 300)
par(mfrow = c(3, 1))
par(cex = 0.75)
...
polygon(c(rev(pp_control_p$year), pp_control_p$year), c(rev(pp_control_p$c95), pp_control_p$c5), col = "firebrick1", border = NA)
...
polygon(c(rev(pp_pipeline_p$year), pp_pipeline_p$year), c(rev(pp_pipeline_p$c95), pp_pipeline_p$c5), col = "firebrick1", border = NA)
...
polygon(c(rev(pp_track_t$year), pp_track_t$year), c(rev(pp_track_t$c95), pp_track_t$c5), col = "firebrick1", border = NA)
...
# mm_scut <- subset(mm, site == "scut")
# mm_nalp <- subset(mm, site == "nalp")
# mm_salp.fir <- subset(mm_salp, species == "fir")
# mm_sshr.fir <- subset(mm_sshr, species == "fir")
# mm_scut.fir <- subset(mm_scut, species == "fir")
# mm_nalp.fir <- subset(mm_nalp, species == "fir")
# mm_salp.spruce <- subset(mm_salp, species == "spruce")
# mm_sshr.spruce <- subset(mm_sshr, species == "spruce")
# mm_scut.spruce <- subset(mm_scut, species == "spruce")
# mm_nalp.spruce <- subset(mm_nalp, species == "spruce")
# 
# ##**********##
# ## Mac Pass ##
# ##**********##
# 
# x1a <- factor(mm_nalp.fir[mm_nalp.fir$sow_year==2013,"treat"], levels = c("1", "3", "2", "4"))
# x2a <- factor(mm_nalp.fir[mm_nalp.fir$sow_year==2014,"treat"], levels = c("1", "3", "2", "4"))
# x3a <- factor(mm_nalp.fir[mm_nalp.fir$sow_year==2015,"treat"], levels = c("1", "3", "2", "4"))
# # x4a <- factor(mm_nalp.fir[mm_nalp.fir$sow_year==2016,"treat"], levels = c("1", "3", "2", "4"))
# x1b <- factor(mm_salp.fir[mm_salp.fir$sow_year==2013,"treat"], levels = c("1", "3", "2", "4"))
# x2b <- factor(mm_salp.fir[mm_salp.fir$sow_year==2014,"treat"], levels = c("1", "3", "2", "4"))
# x3b <- factor(mm_salp.fir[mm_salp.fir$sow_year==2015,"treat"], levels = c("1", "3", "2", "4"))
# # x4b <- factor(mm_salp.fir[mm_salp.fir$sow_year==2016,"treat"], levels = c("1", "3", "2", "4"))
# x1c <- factor(mm_scut.fir[mm_scut.fir$sow_year==2013,"treat"], levels = c("1", "3", "2", "4"))
# x2c <- factor(mm_scut.fir[mm_scut.fir$sow_year==2014,"treat"], levels = c("1", "3", "2", "4"))
# x3c <- factor(mm_scut.fir[mm_scut.fir$sow_year==2015,"treat"], levels = c("1", "3", "2", "4"))
# # x4c <- factor(mm_scut.fir[mm_scut.fir$sow_year==2016,"treat"], levels = c("1", "3", "2", "4"))
# x1d <- factor(mm_sshr.fir[mm_sshr.fir$sow_year==2013,"treat"], levels = c("1", "3", "2", "4"))
# x2d <- factor(mm_sshr.fir[mm_sshr.fir$sow_year==2014,"treat"], levels = c("1", "3", "2", "4"))
# x3d <- factor(mm_sshr.fir[mm_sshr.fir$sow_year==2015,"treat"], levels = c("1", "3", "2", "4"))
# # x4d <- factor(mm_sshr.fir[mm_sshr.fir$sow_year==2016,"treat"], levels = c("1", "3", "2", "4"))
# 
...
# ##
# boxplot(mm_nalp.fir[mm_nalp.fir$sow_year==2013,"germ_prop_via"] ~ x1a, at = c(1,4,7,10), xlim = c(0, 13), ylim = c(0,1), xaxt = "n", yaxt = "n", col = "yellow")
# boxplot(mm_nalp.fir[mm_nalp.fir$sow_year==2014,"germ_prop_via"] ~ x2a, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = "darkorange")
# boxplot(mm_nalp.fir[mm_nalp.fir$sow_year==2015,"germ_prop_via"] ~ x3a, at = c(3,6,9,12), xaxt = "n", add = TRUE, col = "red")
...
# boxplot(mm_salp.fir[mm_salp.fir$sow_year==2013,"germ_prop_via"] ~ x1b, at = c(1,4,7,10), xlim = c(0, 13), ylim = c(0,1), xaxt = "n", yaxt = "n", col = "yellow")
# boxplot(mm_salp.fir[mm_salp.fir$sow_year==2014,"germ_prop_via"] ~ x2b, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = "darkorange")
# boxplot(mm_salp.fir[mm_salp.fir$sow_year==2015,"germ_prop_via"] ~ x3b, at = c(3,6,9,12), xaxt = "n", add = TRUE, col = "red")
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# legend("topleft", "(b) South-facing alpine", bty = "n", inset = c(0.0,-0.3))
# boxplot(mm_scut.fir[mm_scut.fir$sow_year==2013,"germ_prop_via"] ~ x1c, at = c(1,4,7,10), xlim = c(0, 13), ylim = c(0,1), xaxt = "n", yaxt = "n", col = "yellow")
# boxplot(mm_scut.fir[mm_scut.fir$sow_year==2014,"germ_prop_via"] ~ x2c, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = "darkorange")
# boxplot(mm_scut.fir[mm_scut.fir$sow_year==2015,"germ_prop_via"] ~ x3c, at = c(3,6,9,12), xaxt = "n", add = TRUE, col = "red")
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# legend("topleft", "(c) South-facing shrub (cut)", bty = "n", inset = c(0.0,-0.3))
# boxplot(mm_sshr.fir[mm_sshr.fir$sow_year==2013,"germ_prop_via"] ~ x1c, at = c(1,4,7,10), xlim = c(0, 13), ylim = c(0,1), xaxt = "n", yaxt = "n", col = "yellow")
# boxplot(mm_sshr.fir[mm_sshr.fir$sow_year==2014,"germ_prop_via"] ~ x2c, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = "darkorange")
# boxplot(mm_sshr.fir[mm_sshr.fir$sow_year==2015,"germ_prop_via"] ~ x3c, at = c(3,6,9,12), xaxt = "n", add = TRUE, col = "red")
...
# par(mar = c(0, 2, 1, 1), oma = c(5,2,0.5,1))
# ##
# boxplot(mm_nalp.spruce[mm_nalp.spruce$sow_year==2013,"germ_prop_via"] ~ x1a, at = c(1,4,7,10), xlim = c(0, 13), ylim = c(0,1), xaxt = "n", yaxt = "n", col = c("white","white","darkorange","yellow"))
# boxplot(mm_nalp.spruce[mm_nalp.spruce$sow_year==2014,"germ_prop_via"] ~ x2a, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = c("white","white","darkorange","yellow"))
# boxplot(mm_nalp.spruce[mm_nalp.spruce$sow_year==2015,"germ_prop_via"] ~ x3a, at = c(3,6,9,12), xaxt = "n", add = TRUE, col = c("white","white","darkorange","yellow"))
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# legend("topleft", "(a) North-facing alpine", bty = "n", inset = c(0.0,-0.3))
# boxplot(mm_salp.spruce[mm_salp.spruce$sow_year==2013,"germ_prop_via"] ~ x1b, at = c(1,4,7,10), xlim = c(0, 13), ylim = c(0,1), xaxt = "n", yaxt = "n", col = c("white","white","darkorange","yellow"))
# boxplot(mm_salp.spruce[mm_salp.spruce$sow_year==2014,"germ_prop_via"] ~ x2b, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = c("white","white","darkorange","yellow"))
# boxplot(mm_salp.spruce[mm_salp.spruce$sow_year==2015,"germ_prop_via"] ~ x3b, at = c(3,6,9,12), xaxt = "n", add = TRUE, col = c("white","white","darkorange","yellow"))
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# legend("topleft", "(b) South-facing alpine", bty = "n", inset = c(0.0,-0.3))
# boxplot(mm_scut.spruce[mm_scut.spruce$sow_year==2013,"germ_prop_via"] ~ x1c, at = c(1,4,7,10), xlim = c(0, 13), ylim = c(0,1), xaxt = "n", yaxt = "n", col = c("white","white","darkorange","yellow"))
# boxplot(mm_scut.spruce[mm_scut.spruce$sow_year==2014,"germ_prop_via"] ~ x2c, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = c("white","white","darkorange","yellow"))
# boxplot(mm_scut.spruce[mm_scut.spruce$sow_year==2015,"germ_prop_via"] ~ x3c, at = c(3,6,9,12), xaxt = "n", add = TRUE, col = c("white","white","darkorange","yellow"))
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# legend("topleft", "(c) South-facing shrub (cut)", bty = "n", inset = c(0.0,-0.3))
# boxplot(mm_sshr.spruce[mm_sshr.spruce$sow_year==2013,"germ_prop_via"] ~ x1c, at = c(1,4,7,10), xlim = c(0, 13), ylim = c(0,1), xaxt = "n", yaxt = "n", col = c("white","white","darkorange","yellow"))
# boxplot(mm_sshr.spruce[mm_sshr.spruce$sow_year==2014,"germ_prop_via"] ~ x2c, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = c("white","white","darkorange","yellow"))
# boxplot(mm_sshr.spruce[mm_sshr.spruce$sow_year==2015,"germ_prop_via"] ~ x3c, at = c(3,6,9,12), xaxt = "n", add = TRUE, col = c("white","white","darkorange","yellow"))
# axis(1, at = c(2, 5, 8, 11), labels = c("Vegetated","Scarified","Vegetated","Scarified"), tick = TRUE)
# axis(1, at = c(3.5, 9.5), labels = c("Unseeded","Seeded"), tick = FALSE, line = 2)
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# mtext(side = 2, "Germination proportion of viable", outer = TRUE)
...
# 
# x1 <- factor(mm_nalp.fir$treat, levels = c("1", "3", "2", "4"))
# x2 <- factor(mm_salp.fir$treat, levels = c("1", "3", "2", "4"))
# x3 <- factor(mm_scut.fir$treat, levels = c("1", "3", "2", "4"))
# x4 <- factor(mm_sshr.fir$treat, levels = c("1", "3", "2", "4"))
# 
# ## Fir
# par(mfrow = c(4, 1))
# par(ps = 10, cex = 1, cex.axis = 1) # Sets the font size to 18 pts
# par(mar = c(0, 2, 1, 1), oma = c(5,2,0.5,1))
# ##
# boxplot(mm_nalp.fir$surv.1 ~ x1, at = c(1,4,7,10), xlim = c(0, 12), ylim = c(0,1), xaxt = "n", yaxt = "n", col = "darkorange")
# boxplot(mm_nalp.fir$surv.2 ~ x1, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = "red")
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# legend("topleft", "(a) North-facing alpine", bty = "n", inset = c(0.0,-0.3))
# boxplot(mm_salp.fir$surv.1 ~ x2, at = c(1,4,7,10), xlim = c(0, 12), ylim = c(0,1), xaxt = "n", yaxt = "n", col = "darkorange")
# boxplot(mm_salp.fir$surv.2 ~ x2, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = "red")
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# legend("topleft", "(b) South-facing alpine", bty = "n", inset = c(0.0,-0.3))
# boxplot(mm_scut.fir$surv.1 ~ x3, at = c(1,4,7,10), xlim = c(0, 12), ylim = c(0,1), xaxt = "n", yaxt = "n", col = "darkorange")
# boxplot(mm_scut.fir$surv.2 ~ x3, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = "red")
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# legend("topleft", "(c) South-facing shrub (cut)", bty = "n", inset = c(0.0,-0.3))
# boxplot(mm_sshr.fir$surv.1 ~ x4, at = c(1,4,7,10), xlim = c(0, 12), ylim = c(0,1), xaxt = "n", yaxt = "n", col = "darkorange")
# boxplot(mm_sshr.fir$surv.2 ~ x4, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = "red")
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# axis(1, at = c(2, 5, 8, 11), labels = c("Vegetated","Scarified","Vegetated","Scarified"), tick = TRUE)
# axis(1, at = c(3.5, 9.5), labels = c("Unseeded","Seeded"), tick = FALSE, line = 2)
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
...
# 
# ## Spruce
# x1 <- factor(mm_nalp.spruce$treat, levels = c("1", "3", "2", "4"))
# x2 <- factor(mm_salp.spruce$treat, levels = c("1", "3", "2", "4"))
# x3 <- factor(mm_scut.spruce$treat, levels = c("1", "3", "2", "4"))
# x4 <- factor(mm_sshr.spruce$treat, levels = c("1", "3", "2", "4"))
# 
# par(mfrow = c(4, 1))
# par(ps = 10, cex = 1, cex.axis = 1) # Sets the font size to 18 pts
# par(mar = c(0, 2, 1, 1), oma = c(5,2,0.5,1))
# par(xpd = F)
# ##
# boxplot(mm_nalp.spruce$surv.1 ~ x1, at = c(1,4,7,10), xlim = c(0, 12), ylim = c(0,1), xaxt = "n", yaxt = "n", col = c("white","white","darkorange","yellow"))
# boxplot(mm_nalp.spruce$surv.2 ~ x1, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = c("white","white","darkorange","yellow"))
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# legend("topleft", "(a) North-facing alpine", bty = "n", inset = c(0.0,-0.3))
# boxplot(mm_salp.spruce$surv.1 ~ x2, at = c(1,4,7,10), xlim = c(0, 12), ylim = c(0,1), xaxt = "n", yaxt = "n", col = c("white","white","darkorange","yellow"))
# boxplot(mm_salp.spruce$surv.2 ~ x2, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = c("white","white","darkorange","yellow"))
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# legend("topleft", "(b) South-facing alpine", bty = "n", inset = c(0.0,-0.3))
# boxplot(mm_scut.spruce$surv.1 ~ x3, at = c(1,4,7,10), xlim = c(0, 12), ylim = c(0,1), xaxt = "n", yaxt = "n", col = c("white","white","darkorange","yellow"))
# boxplot(mm_scut.spruce$surv.2 ~ x3, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = c("white","white","darkorange","yellow"))
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# legend("topleft", "(c) South-facing shrub (cut)", bty = "n", inset = c(0.0,-0.3))
# boxplot(mm_sshr.spruce$surv.1 ~ x4, at = c(1,4,7,10), xlim = c(0, 12), ylim = c(0,1), xaxt = "n", yaxt = "n", col = c("white","white","darkorange","yellow"))
# boxplot(mm_sshr.spruce$surv.2 ~ x4, at = c(2,5,8,11), xaxt = "n", add = TRUE, col = c("white","white","darkorange","yellow"))
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
# axis(1, at = c(2, 5, 8, 11), labels = c("Vegetated","Scarified","Vegetated","Scarified"), tick = TRUE)
# axis(1, at = c(3.5, 9.5), labels = c("Unseeded","Seeded"), tick = FALSE, line = 2)
# axis(1, at = c(2, 5, 8, 11), labels = c("","","",""), tick = TRUE)
